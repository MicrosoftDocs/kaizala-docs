...
4. [Import "SharepointAnnouncementOnkaizala-SolutionPackage.zip" to your Microsoft Flow account](https://flow.microsoft.com/en-us/blog/import-export-bap-packages/)
