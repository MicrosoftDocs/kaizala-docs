...
**9. Is it possible to create a webhook which can notify on group creation?**</br></br>
...
**10. Do connectors have to be added manually to every group?**</br></br>
  If the connector is created from Tenant Admin, then you do not have to add the connector manually to every group. 
<br/><br/>


**11. How can I fetch complete responses of all participants in a Survey?**</br></br>
...
**1. How can I get started with Custom Action Development? Is there any documentation available?**</br></br>
  Custom Action Development and related documentation is under Preview and is covered under NDA. You can start by reading [this](Actions/README.md). </br>
  In case you have any queries, you can [contact us](feedback.md).
<br/><br/>

**2. How can I get the latest Kaizala Action SDK?**</br></br>

  You can find the latest Action SDK [here]()
<br/><br/> 

 **3. How can I test/debug a Custom Action without having to upload a package every time?**</br></br>

  To test a custom Action, read more about the steps/process [here](Actions/test.md) 
<br/><br/>


 **4. What are guidelines that Action Package must follow?**</br></br>
As a developer, you must adhere to guidelines while developing a custom Action Package.Please find them [here](Actions/validation.md). Microsoft Kaizala can remove your Action from the app, if it finds any inconsistencies.
<br/><br/>
